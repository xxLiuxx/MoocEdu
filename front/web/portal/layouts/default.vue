    ...
    <header id="header">
      <section class="container">
        ...
        <div class="h-r-nsl">
          ...
          <ul class="h-r-login">
            <li id="no-login">
              <a href="javascript:lrFun(1)" title="Login">
                <em class="icon18 login-icon">&nbsp;</em>
                <span class="vam ml5">Login</span>
              </a>
              |
              <a href="javascript:lrFun(2)" title="Register">
            ...
            <li class="h-r-user undis" id="is-login-two">
              ...
              <a href="javascript:void(0)" title="Logout" onclick="exit();" class="ml5">Logout</a>
            </li>
            <!-- /not login li1, login li2 li3 -->
          </ul>
