              ...
              <ul class="of" id="bna">
                <li>
                  <div class="cc-l-wrap">
                    ...
                    <h3 class="hLh30 txtOf mt10">
                      <a href="#" title="Listening & Speaking" class="course-title fsize18 c-333">Listening & Speaking</a>
                    </h3>
                ...
                <li>
                  <div class="cc-l-wrap">
                    ...
                    <h3 class="hLh30 txtOf mt10">
                      <a href="#" title="Advanced Java" class="course-title fsize18 c-333">Advanced Java</a>
                    </h3>
                    <section class="mt10 hLh20 of">
                      <span class="fr jgTag bg-green">
                        <i class="c-fff fsize12 f-fA">free</i>
                      ...
                      <span class="fl jgAttr c-ccc f-fA">
                        <i class="c-999 f-fA">501 students</i>
                        |
                        <i class="c-999 f-fA">501 reviews</i>
                      </span>
                    </section>
                  </div>
                </li>
                <li>
                  <div class="cc-l-wrap">
                    ...
                    <h3 class="hLh30 txtOf mt10">
                      <a href="#" title="C4D Intro" class="course-title fsize18 c-333">C4D Intro</a>
                    </h3>
                    <section class="mt10 hLh20 of">
                      <span class="fr jgTag bg-green">
                        <i class="c-fff fsize12 f-fA">free</i>
                      ...
                      <span class="fl jgAttr c-ccc f-fA">
                        <i class="c-999 f-fA">300 students</i>
                        |
                        <i class="c-999 f-fA">300 reviews</i>
                      </span>
                    </section>
                  </div>
                </li>
